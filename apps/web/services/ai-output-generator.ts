...
function createSystemPrompt() {
  return [
    ...
    "1. Brand profile is the authoritative source for voice, audience, positioning, preferred style, forbidden phrases, forbidden symbols, emoji usage, hashtag rules, CTA behavior, length, and platform-specific behavior.",
    ...
    "Do not use forbidden phrases or forbidden symbols.",
